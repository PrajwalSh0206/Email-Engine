...
const Login = () => {
  ...
  return (
    <div className="bg-gray-200 h-screen w-full flex items-center justify-center">
      <div className="w-6/12 lg:w-1/3 p-5 bg-white rounded-md border-gray-500 flex flex-col justify-center">
        <button
          onClick={handleClick}
          className="p-3 space-x-5 flex items-center justify-center border-2 border-gray-400 transition-transform active:scale-95 active:bg-gray-100"
        >
          <svg width="24px" height="24px" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="#000000">
            <path
              ...
              stroke-width="1.5"
            ></path>
            <path d="M4 12H20" stroke="#000000" stroke-width="1.5"></path>
            <path d="M10.5 5.5V18.5" stroke="#000000" stroke-width="1.5"></path>
          </svg>
